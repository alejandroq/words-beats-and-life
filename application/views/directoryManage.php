...
<div id="form-window" class="container">
  	<div class="row">
		...
		<h4 class="offset-by-two four columns">Directory Management  |  {{method}} User</h4>
   	...
   	<form name="form" ng-submit="submitForm(form.$valid)" class="row" novalidate>
	   	...
	   	<div class="row">
	   		...
	   		<input type="email" ng-model="data.EmailAddress" min-length="3" max-length="25" class="six columns offset-by-three" placeholder="Email Address" value="{{data.EmailAddress}}"required>

	   	</div>
	  	<div class="row">

	   		<input type="email" ng-model="data.confirmEmailAddress" min-length="3" max-length="25" class="six columns offset-by-three" placeholder="Confirm Email Address" value="{{data.confirmEmailAddress}}" ng-hide="method == 'Update'">

	   	</div>
	   	<div class="row">

	   		<input type="password" ng-model="data.Password" min-length="3" max-length="15" class="six columns offset-by-three" placeholder="Password" ng-hide="method == 'Update'" ng-required = "method=='Add'">

	   		<input type="password" ng-model="data.InputPassword" min-length="3" max-length="15" class="six columns offset-by-three" placeholder="Old Password" ng-show="method == 'Update'" >
	   	...
	   	<div class="row">
	   		...
	   		<select ng-model="data.UserType" selected="{{data.UserType}}" class="three columns" required>
	   			...
	   			<option ng-model="Admin" value="Administrator">Administrator</option>
		...
		<div id="Administrator-Info" class="row" ng-hide="data.UserType!='Administrator'">

			<input type="email" ng-model="data.ManagerEmail" min-length="3" max-length="25" class="offset-by-three three columns" values="{{data.ManagerEmail}}" placeholder="Manager Email" />
			<input type="text" ng-model="data.AdminTitle" min-length="3" max-length="15" class="three columns" value="{{data.AdminTitle}}" placeholder="Administrator Title" />

	   	</div>
	   	<div id="Staff-Info" class="row" ng-hide="data.UserType!='Staff'">

	   		<input type="email" ng-model="data.AdminEmailAddress" min-length="3" max-length="25" class="offset-by-three three columns" values="{{data.AdminEmailAddress}}" placeholder="Manager Email" />
	   		<input type="text" ng-model="data.StaffType" class="three columns" value="{{data.StaffType}}" placeholder="Staff Title" />
